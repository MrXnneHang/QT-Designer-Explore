...
"")
        ...
        self.t1_switch_t2 = QtWidgets.QPushButton(self.tab_1)
        self.t1_switch_t2.setGeometry(QtCore.QRect(10, 90, 281, 141))
        self.t1_switch_t2.setStyleSheet("font-family: \"Microsoft YaHei\";")
        self.t1_switch_t2.setObjectName("t1_switch_t2")
        ...
        self.t2_swicth_t1 = QtWidgets.QPushButton(self.tab_2)
        self.t2_swicth_t1.setGeometry(QtCore.QRect(110, 90, 281, 141))
        self.t2_swicth_t1.setStyleSheet("font-family: \"Microsoft YaHei\";")
        self.t2_swicth_t1.setObjectName("t2_swicth_t1")
    ...
    def retranslateUi(self, Tab):
        ...
        self.t1_switch_t2.setText(_translate("Tab", "Switch To Tab 2"))
        ...
        self.t2_swicth_t1.setText(_translate("Tab", "Switch To Tab 1"))
